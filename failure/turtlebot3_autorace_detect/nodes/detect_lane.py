...
class DetectLane():
    ...
    def cbFindLane(self, image_msg):
        ...
        white_fraction, cv_white_lane, white_coords = self.maskWhiteLane(cv_image)
        yellow_fraction, cv_yellow_lane, yellow_coords = self.maskYellowLane(cv_image)

        N=100
        simplified_white_coords = white_coords[::N]
        simplified_yellow_coords = yellow_coords[::N]

        #print("white line coords:",simplified_white_coords)
        #print("yellow line coords:",simplified_yellow_coords)
    ...
    ########################################################################
        ...
        return fraction_num, mask, white_coords
    ...
    def maskYellowLane(self, image):
        ...
        return fraction_num, mask, yellow_coords
